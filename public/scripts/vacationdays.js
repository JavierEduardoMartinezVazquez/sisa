'use strict'
    ...
    function obtenerultimoidvacationdays(){
        $.get(obtener_ultimo_id_vacationdays, function(numero){
...
function verificarbajavacationdays(numero){
    $.get(verificar_baja_vacationdays, {numero:numero}, function(data){
        if(data.status == 'BAJA'){
