'use strict'
    ...
    function obtenerultimoidpermissionsreports(){
        $.get(obtener_ultimo_id_permissionsreports, function(numero){
    ...
    $("#btnGuardar").on('click', function (e) {
        ...
        if (form.parsley().isValid()){
            $.ajax({
                ...
                url: guardar_permissionsreports,
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
    ...
    function listarpermissionsreports() {
        $("#tablelist").DataTable({
          "autoWidth": false,
          "sScrollX": "110%",
          "sScrollY": "350px",
        ...
        ajax: listar_permissionsreports,
...
$("#btnGuardarModificacion").on('click', function (e) {
    ...
    if (form.parsley().isValid()){
        $.ajax({
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            url:modificar_permissionsreports,
            type: "post",
            dataType: "html",
            data: formData,
            cache: false,
...
function verificarbajapermissionsreports(numero){
    $.get(verificar_baja_permissionsreports, {numero:numero}, function(data){
        if(data.status == 'BAJA'){
