'use strict'
    ...
    function obtenerultimoidnominas(){
        $.get(obtener_ultimo_id_nominas, function(numero){
    ...
    function obtenernominas(numero){
        ...
        $.get(obtener_nominas,{numero:numero },function(data){
            ...
            $("#txtnumero").val(data.nominas.id);
            $("#txtnombre").val(data.nominas.nombre);
...
function verificarbajanominas(numero){
    $.get(verificar_baja_nominas, {numero:numero}, function(data){
        if(data.status == 'BAJA'){
